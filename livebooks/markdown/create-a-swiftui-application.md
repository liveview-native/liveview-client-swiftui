...
![Xcode Create New Project](https://i.imgur.com/BRN1G7F.png)
...
![Xcode Create Template For New Project](https://i.imgur.com/hrk69Ew.png)

<!-- livebook:{"break_markdown":true} -->

Choose options for your new project that match the following image, then click **Next**.

![Xcode Choose Options For Your New Project](https://i.imgur.com/aIbVIVG.png)
...
![Xcode select folder location](https://i.imgur.com/SoHH1aF.png)
...
![Xcode some build plugins are disabled](https://i.imgur.com/atm2BlO.png)
...
![LiveViewNativeStylesheet macros was disabled because it recently changed. Enable it now?](https://i.imgur.com/d0RxGnD.png)

<!-- livebook:{"break_markdown":true} -->

![LiveViewNativeMacros macros was disabled because it recently changed. Enable it now?](https://i.imgur.com/BZbwJ5h.png)

<!-- livebook:{"break_markdown":true} -->

![CasePathMacros macros was disabled because it recently changed. Enable it now?](https://i.imgur.com/WdZZghm.png)
...
<img style="width: 100%; height: 100%; object-fit: contain" src="https://i.imgur.com/VFpZuvq.png"/>
</div>
