...
struct ScrollView<R: RootRegistry>: View {
    ...
    @_documentation(visibility: public)
    @Attribute(.init(name: "axes")) private var axes: Axis.Set = .vertical
    /// Whether the scroll indicators are shown (defaults to true).
    @_documentation(visibility: public)
    @Attribute(.init(name: "showsIndicators")) private var showsIndicators: Bool = true
    ...
    @_documentation(visibility: public)
    @Attribute(.init(name: "scrollPosition")) private var scrollPosition: String?
    ...
    @_documentation(visibility: public)
    @Attribute(.init(name: "scrollPositionAnchor")) private var scrollPositionAnchor: UnitPoint?
