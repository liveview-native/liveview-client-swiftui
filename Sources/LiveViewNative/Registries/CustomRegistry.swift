...
public protocol CustomRegistry<Root> {
    ...
    /// The type of view modifier this registry can decode.
    associatedtype CustomModifier: ViewModifier & Decodable = _EmptyDecodableModifier
...
public struct _EmptyDecodableModifier: ViewModifier, Decodable {
