...
public class LiveSessionCoordinator<R: RootRegistry>: ObservableObject {
    ...
    let stylesheet = try! Stylesheet<BuiltinRegistry<R>.BuiltinModifier>(from: "%{\"test\" => [{:transition, [], [{:., [], [nil, {:., [], [{:move, [], [[from: {:., [], [nil, :leading]}]]}, {:combined, [], [[with: {:., [], [nil, :opacity]}]]}]}]}]}]}", in: ParseableModifierContext())
