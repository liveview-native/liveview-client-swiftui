...
struct _fontDesignModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(tvOS) || os(watchOS) || os(macOS) || os(iOS)
    @available(tvOS 16.1,watchOS 9.1,macOS 13.0,iOS 16.1, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(tvOS) || os(watchOS) || os(macOS) || os(iOS)
        case let ._0(design):
            if #available(tvOS 16.1,watchOS 9.1,macOS 13.0,iOS 16.1, *) {
...
struct _hoverEffectModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(xrOS) || os(tvOS) || os(iOS)
    @available(xrOS 1.0,tvOS 16.0,iOS 13.4, *)
    ...
    #endif
    #if os(iOS) || os(xrOS) || os(tvOS)
    @available(iOS 17.0,xrOS 1.0,tvOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(xrOS) || os(tvOS) || os(iOS)
        case let ._0(effect):
            if #available(xrOS 1.0,tvOS 16.0,iOS 13.4, *) {
        ...
        case let ._1(effect, isEnabled):
            if #available(iOS 17.0,xrOS 1.0,tvOS 17.0, *) {
            let effect = effect as! SwiftUI.HoverEffect 
...
struct _hoverEffectDisabledModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(xrOS) || os(tvOS) || os(iOS)
    @available(xrOS 1.0,tvOS 17.0,iOS 17.0, *)
    init(_ disabled: AttributeReference<Swift.Bool> ) {
        self.value = ._0(disabled: disabled)
...
struct _textEditorStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(xrOS) || os(macOS)
    @available(iOS 17.0,xrOS 1.0,macOS 14.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(xrOS) || os(macOS)
        case let ._0(style):
            if #available(iOS 17.0,xrOS 1.0,macOS 14.0, *) {
...
#if os(tvOS) || os(iOS)
if #available(macOS 12.0,tvOS 17.0,iOS 15.0,watchOS 8.0, *) {
...
#if os(macOS) || os(iOS) || os(xrOS) || os(watchOS)
if #available(macOS 14.0,iOS 17.0,xrOS 1.0,watchOS 10.0, *) {
