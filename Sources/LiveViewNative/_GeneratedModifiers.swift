...
struct _accessibilityActionsModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 18.0,watchOS 11.0,visionOS 2.0,iOS 18.0,macOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(category, content):
            if #available(tvOS 18.0,watchOS 11.0,visionOS 2.0,iOS 18.0,macOS 15.0, *) {
...
struct _contextMenuModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(iOS 16.0,macOS 13.0,visionOS 1.0,tvOS 16.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._1(menuItems, preview):
            if #available(iOS 16.0,macOS 13.0,visionOS 1.0,tvOS 16.0, *) {
...
@ChangeTracked private var _3_isSuppressed: Swift.Bool
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 17.0,tvOS 17.0,macOS 14.0,visionOS 1.0,watchOS 10.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(titleKey):
            if #available(iOS 17.0,tvOS 17.0,macOS 14.0,visionOS 1.0,watchOS 10.0, *) {
...
@Event private var _2_onFocusChange__1: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 17.0,visionOS 1.0,watchOS 8.0,macOS 12.0,tvOS 15.0, *)
    ...
    #endif
    #if os(macOS) || os(tvOS) || os(watchOS)
    @available(tvOS 16.0,watchOS 9.0,macOS 13.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(isFocusable):
            if #available(iOS 17.0,visionOS 1.0,watchOS 8.0,macOS 12.0,tvOS 15.0, *) {
...
let interactions = interactions as! SwiftUI.FocusInteractions
        ...
        case let ._2(isFocusable):
            if #available(tvOS 16.0,watchOS 9.0,macOS 13.0, *) {
            let isFocusable = isFocusable as! AttributeReference<Swift.Bool>
...
struct _gaugeStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 13.0,visionOS 1.0,iOS 16.0,watchOS 7.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(macOS 13.0,visionOS 1.0,iOS 16.0,watchOS 7.0, *) {
...
struct _gestureModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 11.0,visionOS 2.0,tvOS 18.0,macOS 15.0,iOS 18.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._2(gesture, name, isEnabled):
            if #available(watchOS 11.0,visionOS 2.0,tvOS 18.0,macOS 15.0,iOS 18.0, *) {
...
struct _navigationBarHiddenModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 13.0,visionOS 1.0,macOS 13.0,tvOS 13.0,watchOS 6.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(hidden):
            if #available(iOS 13.0,visionOS 1.0,macOS 13.0,tvOS 13.0,watchOS 6.0, *) {
...
struct _navigationBarTitleModifier<R: RootRegistry>: ViewModifier {
    ...
    #endif
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 13.0,tvOS 13.0,iOS 13.0,visionOS 1.0,watchOS 6.0, *)
    ...
    #endif
    #if os(iOS) || os(visionOS)
    @available(tvOS 13.0,iOS 13.0,macOS 13.0,watchOS 6.0,visionOS 1.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._1(titleKey):
            if #available(macOS 13.0,tvOS 13.0,iOS 13.0,visionOS 1.0,watchOS 6.0, *) {
            let titleKey = titleKey as! SwiftUICore.LocalizedStringKey
...
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
        ...
        case let ._4(titleKey, displayMode):
            if #available(tvOS 13.0,iOS 13.0,macOS 13.0,watchOS 6.0,visionOS 1.0, *) {
            let titleKey = titleKey as! SwiftUICore.LocalizedStringKey
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
...
self.__1_onPressingChanged__1 = onPressingChanged__1
    ...
    #endif
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 10.15,tvOS 14.0,iOS 13.0,watchOS 6.0,visionOS 1.0, *)
...
let maximumDistance = maximumDistance as! AttributeReference<CoreFoundation.CGFloat>
        ...
        case let ._2(minimumDuration, maximumDistance):
            if #available(macOS 10.15,tvOS 14.0,iOS 13.0,watchOS 6.0,visionOS 1.0, *) {
            let minimumDuration = minimumDuration as! AttributeReference<Swift.Double>
let maximumDistance = maximumDistance as! AttributeReference<CoreFoundation.CGFloat>
...
@Event private var _1_action__0: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 14.0,visionOS 1.0,iOS 17.0,watchOS 10.0, *)
...
struct _presentationBackgroundInteractionModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 13.3,tvOS 16.4,iOS 16.4,visionOS 1.0,watchOS 9.4, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(interaction):
            if #available(macOS 13.3,tvOS 16.4,iOS 16.4,visionOS 1.0,watchOS 9.4, *) {
...
struct _presentationSizingModifier<R: RootRegistry>: ViewModifier {
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(sizing):
            if #available(iOS 18.0,macOS 15.0,visionOS 2.0,watchOS 11.0,tvOS 18.0, *) {
...
struct _scrollContentBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(watchOS 9.0,visionOS 1.0,macOS 13.0,iOS 16.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
        self.value = ._0(visibility: visibility)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility):
            if #available(watchOS 9.0,visionOS 1.0,macOS 13.0,iOS 16.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _textSelectionAffinityModifier<R: RootRegistry>: ViewModifier {
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(affinity):
            if #available(iOS 18.0,visionOS 2.0,watchOS 11.0,macOS 15.0,tvOS 18.0, *) {
...
if #available(iOS 18.0,macOS 14.0,watchOS 10.0,tvOS 17.0, *) {
...
if #available(iOS 18.0,macOS 14.0,watchOS 11.0,tvOS 17.0, *) {
...
if #available(iOS 17.0,macOS 15.0,watchOS 10.0,tvOS 17.0, *) {
    return Self.window
...
if #available(macOS 12.0,iOS 15.0,tvOS 17.0,watchOS 8.0,visionOS 1.0, *) {
...
if #available(macOS 12.0,iOS 15.0,tvOS 18.0,watchOS 8.0,visionOS 1.0, *) {
...
/// * `.standard`
@_documentation(visibility: public)
@available(iOS 17.0,macOS 13.0,watchOS 10.0,tvOS 17.0,visionOS 1.0, *)
...
if #available(watchOS 9.0,iOS 16.0,visionOS 1.0,tvOS 16.0,macOS 13.0, *) {
...
/// * `.scrolls`
@_documentation(visibility: public)
@available(watchOS 9.4,visionOS 1.0,iOS 16.4,tvOS 16.4,macOS 13.3, *)
...
/// * `.disabled`
@_documentation(visibility: public)
@available(macOS 14.0,watchOS 10.0,iOS 17.0,visionOS 1.0,tvOS 17.0, *)
...
if #available(iOS 18.0,macOS 15.0,watchOS 10.0,tvOS 17.0,visionOS 2.0, *) {
    return Self.title
...
if #available(watchOS 9.0,visionOS 1.0,iOS 16.0,tvOS 16.0,macOS 13.0, *) {
