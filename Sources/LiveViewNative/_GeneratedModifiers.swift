...
struct _gestureModifier<R: RootRegistry>: ViewModifier {
    ...
    enum Value {
        ...
        indirect case _0(gesture: _AnyGesture,mask: SwiftUI.GestureMask = .all )
...
indirect case chunk15(_BuiltinModifierChunk15)
        indirect case _OnDeleteModifier(LiveViewNative._OnDeleteModifier)
...
case let .chunk15(chunk):
    content.modifier(chunk)
            case let ._OnDeleteModifier(modifier):
    content.modifier(modifier)
...
_zIndexModifier<R>.name: _zIndexModifier<R>.parser(in: context).map({ Output.chunk15(.zIndex($0)) }).eraseToAnyParser(),
                    LiveViewNative._OnDeleteModifier.name: LiveViewNative._OnDeleteModifier.parser(in: context).map(Output._OnDeleteModifier).eraseToAnyParser(),
...
if #available(watchOS 8.0,visionOS 1.0,tvOS 15.0,iOS 15.0,macOS 12.0, *) {
...
if #available(watchOS 8.0,visionOS 1.0,tvOS 17.0,iOS 15.0,macOS 12.0, *) {
...
/// * `.standard`
@_documentation(visibility: public)
@available(tvOS 17.0,macOS 13.0,iOS 17.0,watchOS 10.0,visionOS 1.0, *)
...
/// * `.fullScreenCover`
@_documentation(visibility: public)
@available(visionOS 1.0,tvOS 16.4,macOS 13.3,iOS 16.4,watchOS 9.4, *)
