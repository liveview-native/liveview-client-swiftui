...
struct _automationElementModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 18.1,macOS 15.1,iOS 18.1,watchOS 11.1,visionOS 2.1, *)
    init() {
        self.value = ._0
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case ._0:
            if #available(tvOS 18.1,macOS 15.1,iOS 18.1,watchOS 11.1,visionOS 2.1, *) {
...
struct _contextMenuModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(tvOS 16.0,iOS 16.0,visionOS 1.0,macOS 13.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._1(menuItems, preview):
            if #available(tvOS 16.0,iOS 16.0,visionOS 1.0,macOS 13.0, *) {
...
struct _controlSizeModifier<R: RootRegistry>: ViewModifier {
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(controlSize):
            if #available(iOS 15.0,macOS 10.15,visionOS 1.0,watchOS 9.0, *) {
...
struct _datePickerStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(watchOS 10.0,macOS 10.15,visionOS 1.0,iOS 13.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(watchOS 10.0,macOS 10.15,visionOS 1.0,iOS 13.0, *) {
...
@Event private var _2_onFocusChange__1: Event.EventHandler
    ...
    #endif
    #if os(macOS) || os(tvOS) || os(watchOS)
    @available(macOS 13.0,watchOS 9.0,tvOS 16.0, *)
...
let interactions = interactions as! SwiftUI.FocusInteractions
        ...
        case let ._2(isFocusable):
            if #available(macOS 13.0,watchOS 9.0,tvOS 16.0, *) {
            let isFocusable = isFocusable as! AttributeReference<Swift.Bool>
...
struct _handGestureShortcutModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(watchOS)
    @available(tvOS 18.0,macOS 15.0,watchOS 11.0,iOS 18.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(shortcut, isEnabled):
            if #available(tvOS 18.0,macOS 15.0,watchOS 11.0,iOS 18.0, *) {
...
struct _indexViewStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 14.0,visionOS 1.0,iOS 14.0,watchOS 8.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(tvOS 14.0,visionOS 1.0,iOS 14.0,watchOS 8.0, *) {
...
struct _menuStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(visionOS 1.0,iOS 14.0,macOS 11.0,tvOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
        case let ._0(style):
            if #available(visionOS 1.0,iOS 14.0,macOS 11.0,tvOS 17.0, *) {
...
struct _navigationBarHiddenModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 13.0,macOS 13.0,watchOS 6.0,iOS 13.0,visionOS 1.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(hidden):
            if #available(tvOS 13.0,macOS 13.0,watchOS 6.0,iOS 13.0,visionOS 1.0, *) {
...
struct _navigationBarTitleModifier<R: RootRegistry>: ViewModifier {
    ...
    #endif
    #if os(iOS) || os(visionOS)
    @available(watchOS 6.0,macOS 13.0,tvOS 13.0,visionOS 1.0,iOS 13.0, *)
...
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
        ...
        case let ._5(title, displayMode):
            if #available(watchOS 6.0,macOS 13.0,tvOS 13.0,visionOS 1.0,iOS 13.0, *) {
            let title = title as! AttributeReference<String>
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
...
@ChangeTracked private var _4_title: Swift.String
    ...
    #if os(watchOS)
    @available(tvOS 14.0,iOS 14.0,watchOS 7.0,macOS 11.0, *)
...
@Event private var _3_action__0: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(watchOS 6.0,visionOS 1.0,iOS 13.0,tvOS 14.0,macOS 10.15, *)
...
self.__3_action__0 = action__0
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(minimumDuration, maximumDistance):
            if #available(watchOS 6.0,visionOS 1.0,iOS 13.0,tvOS 14.0,macOS 10.15, *) {
...
@Event private var _0_action__1: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 11.0,visionOS 2.0,iOS 18.0,tvOS 18.0,macOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(threshold):
            if #available(watchOS 11.0,visionOS 2.0,iOS 18.0,tvOS 18.0,macOS 15.0, *) {
...
struct _scrollContentBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(iOS 16.0,visionOS 1.0,watchOS 9.0,macOS 13.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
        self.value = ._0(visibility: visibility)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility):
            if #available(iOS 16.0,visionOS 1.0,watchOS 9.0,macOS 13.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _textInputAutocapitalizationModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 15.0,visionOS 1.0,iOS 15.0,watchOS 8.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(autocapitalization):
            if #available(tvOS 15.0,visionOS 1.0,iOS 15.0,watchOS 8.0, *) {
...
/// * `.sidebar`
@_documentation(visibility: public)
@available(visionOS 2.0,macOS 15.0,tvOS 18.0,watchOS 11.0,iOS 18.0, *)
...
/// * `.disabled`
@_documentation(visibility: public)
@available(visionOS 1.0,macOS 14.0,tvOS 17.0,watchOS 10.0,iOS 17.0, *)
...
if #available(iOS 18.0,macOS 14.0,tvOS 17.0,watchOS 10.0, *) {
...
if #available(iOS 18.0,macOS 14.0,tvOS 17.0,watchOS 11.0, *) {
...
/// * `.standard`
@_documentation(visibility: public)
@available(visionOS 1.0,iOS 17.0,macOS 13.0,tvOS 17.0,watchOS 10.0, *)
...
if #available(iOS 16.0,tvOS 16.0,visionOS 1.0,watchOS 9.0,macOS 13.0, *) {
...
/// * `.scrolls`
@_documentation(visibility: public)
@available(visionOS 1.0,macOS 13.3,tvOS 16.4,watchOS 9.4,iOS 16.4, *)
...
if #available(visionOS 2.0,iOS 18.0,macOS 15.0,tvOS 17.0,watchOS 10.0, *) {
    return Self.title
...
if #available(visionOS 1.0,macOS 13.0,tvOS 16.0,watchOS 9.0,iOS 16.0, *) {
