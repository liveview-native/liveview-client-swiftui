...
struct _contextMenuModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(macOS 13.0,visionOS 1.0,tvOS 16.0,iOS 16.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._1(menuItems, preview):
            if #available(macOS 13.0,visionOS 1.0,tvOS 16.0,iOS 16.0, *) {
...
struct _controlSizeModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(iOS 15.0,watchOS 9.0,visionOS 1.0,macOS 10.15, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(controlSize):
            if #available(iOS 15.0,watchOS 9.0,visionOS 1.0,macOS 10.15, *) {
...
struct _datePickerStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 10.15,watchOS 10.0,visionOS 1.0,iOS 13.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(macOS 10.15,watchOS 10.0,visionOS 1.0,iOS 13.0, *) {
...
struct _defaultScrollAnchorModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 10.0,tvOS 17.0,macOS 14.0,visionOS 1.0,iOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(anchor):
            if #available(watchOS 10.0,tvOS 17.0,macOS 14.0,visionOS 1.0,iOS 17.0, *) {
...
@Event private var _2_onFocusChange__1: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 8.0,tvOS 15.0,macOS 12.0,visionOS 1.0,iOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(isFocusable):
            if #available(watchOS 8.0,tvOS 15.0,macOS 12.0,visionOS 1.0,iOS 17.0, *) {
...
@Event private var _0_onDismiss__0: Event.EventHandler
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 14.0,watchOS 7.0,visionOS 1.0,tvOS 14.0, *)
...
self.__0_onDismiss__0 = onDismiss__0
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(content):
            if #available(iOS 14.0,watchOS 7.0,visionOS 1.0,tvOS 14.0, *) {
            let content = content as! ViewReference
...
struct _gaugeStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(watchOS 7.0,macOS 13.0,visionOS 1.0,iOS 16.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(watchOS 7.0,macOS 13.0,visionOS 1.0,iOS 16.0, *) {
...
struct _indexViewStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 8.0,visionOS 1.0,tvOS 14.0,iOS 14.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(watchOS 8.0,visionOS 1.0,tvOS 14.0,iOS 14.0, *) {
...
struct _menuStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(tvOS 17.0,macOS 11.0,visionOS 1.0,iOS 14.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
        case let ._0(style):
            if #available(tvOS 17.0,macOS 11.0,visionOS 1.0,iOS 14.0, *) {
...
struct _navigationBarHiddenModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,iOS 13.0,macOS 13.0,tvOS 13.0,watchOS 6.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(hidden):
            if #available(visionOS 1.0,iOS 13.0,macOS 13.0,tvOS 13.0,watchOS 6.0, *) {
...
struct _navigationBarTitleModifier<R: RootRegistry>: ViewModifier {
    ...
    #endif
    #if os(iOS) || os(visionOS)
    @available(iOS 13.0,tvOS 13.0,watchOS 6.0,visionOS 1.0,macOS 13.0, *)
...
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
        ...
        case let ._5(title, displayMode):
            if #available(iOS 13.0,tvOS 13.0,watchOS 6.0,visionOS 1.0,macOS 13.0, *) {
            let title = title as! AttributeReference<String>
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
...
@Event private var _3_action__0: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 10.15,watchOS 6.0,visionOS 1.0,iOS 13.0,tvOS 14.0, *)
...
self.__3_action__0 = action__0
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(minimumDuration, maximumDistance):
            if #available(macOS 10.15,watchOS 6.0,visionOS 1.0,iOS 13.0,tvOS 14.0, *) {
...
struct _presentationBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 9.4,tvOS 16.4,macOS 13.3,visionOS 1.0,iOS 16.4, *)
    init(_ style: AnyShapeStyle.Resolvable) {
        self.value = ._0(style: style)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(watchOS 9.4,tvOS 16.4,macOS 13.3,visionOS 1.0,iOS 16.4, *) {
...
struct _presentationSizingModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 18.0,visionOS 2.0,watchOS 11.0,tvOS 18.0,macOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(sizing):
            if #available(iOS 18.0,visionOS 2.0,watchOS 11.0,tvOS 18.0,macOS 15.0, *) {
...
struct _scrollBounceBehaviorModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 16.4,watchOS 9.4,visionOS 1.0,tvOS 16.4,macOS 13.3, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(behavior, axes):
            if #available(iOS 16.4,watchOS 9.4,visionOS 1.0,tvOS 16.4,macOS 13.3, *) {
...
struct _scrollContentBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 13.0,watchOS 9.0,visionOS 1.0,iOS 16.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
        self.value = ._0(visibility: visibility)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility):
            if #available(macOS 13.0,watchOS 9.0,visionOS 1.0,iOS 16.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _swipeActionsModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 12.0,watchOS 8.0,visionOS 1.0,iOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(edge, allowsFullSwipe, content):
            if #available(macOS 12.0,watchOS 8.0,visionOS 1.0,iOS 15.0, *) {
...
struct _textInputAutocapitalizationModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 8.0,tvOS 15.0,visionOS 1.0,iOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(autocapitalization):
            if #available(watchOS 8.0,tvOS 15.0,visionOS 1.0,iOS 15.0, *) {
...
struct _toolbarBackgroundVisibilityModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 15.0,watchOS 11.0,tvOS 18.0,visionOS 2.0,iOS 18.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>,for bars: SwiftUI.ToolbarPlacement) {
        self.value = ._0(visibility: visibility, bars: bars)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility, bars):
            if #available(macOS 15.0,watchOS 11.0,tvOS 18.0,visionOS 2.0,iOS 18.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
/// * `.sidebar`
@_documentation(visibility: public)
@available(tvOS 18.0,macOS 15.0,visionOS 2.0,watchOS 11.0,iOS 18.0, *)
...
if #available(iOS 18.0,tvOS 17.0,macOS 14.0,watchOS 10.0, *) {
...
if #available(iOS 18.0,tvOS 17.0,macOS 14.0,watchOS 11.0, *) {
...
if #available(iOS 17.0,tvOS 17.0,macOS 15.0,watchOS 10.0, *) {
    return Self.window
...
if #available(watchOS 8.0,macOS 12.0,tvOS 15.0,visionOS 1.0,iOS 15.0, *) {
...
if #available(watchOS 8.0,macOS 12.0,tvOS 17.0,visionOS 1.0,iOS 15.0, *) {
...
if #available(watchOS 8.0,macOS 12.0,tvOS 18.0,visionOS 1.0,iOS 15.0, *) {
...
/// * `.standard`
@_documentation(visibility: public)
@available(iOS 17.0,tvOS 17.0,macOS 13.0,watchOS 10.0,visionOS 1.0, *)
...
if #available(watchOS 9.0,tvOS 16.0,iOS 16.0,macOS 13.0,visionOS 1.0, *) {
...
/// * `.alignment`
@_documentation(visibility: public)
@available(iOS 18.0,tvOS 18.0,macOS 15.0,watchOS 11.0,visionOS 2.0, *)
...
if #available(iOS 18.0,tvOS 17.0,macOS 15.0,watchOS 10.0,visionOS 2.0, *) {
    return Self.title
...
if #available(tvOS 16.0,macOS 13.0,visionOS 1.0,watchOS 9.0,iOS 16.0, *) {
