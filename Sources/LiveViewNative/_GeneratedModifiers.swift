...
struct _contextMenuModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(visionOS 1.0,macOS 13.0,tvOS 16.0,iOS 16.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._1(menuItems, preview):
            if #available(visionOS 1.0,macOS 13.0,tvOS 16.0,iOS 16.0, *) {
...
struct _controlGroupStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(macOS 12.0,tvOS 17.0,visionOS 1.0,iOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
        case let ._0(style):
            if #available(macOS 12.0,tvOS 17.0,visionOS 1.0,iOS 15.0, *) {
...
struct _controlSizeModifier<R: RootRegistry>: ViewModifier {
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(controlSize):
            if #available(visionOS 1.0,macOS 10.15,iOS 15.0,watchOS 9.0, *) {
...
struct _focusEffectDisabledModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 14.0,tvOS 17.0,visionOS 1.0,iOS 17.0,watchOS 10.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(disabled):
            if #available(macOS 14.0,tvOS 17.0,visionOS 1.0,iOS 17.0,watchOS 10.0, *) {
...
@Event private var _2_onFocusChange__1: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 12.0,tvOS 15.0,visionOS 1.0,iOS 17.0,watchOS 8.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(isFocusable):
            if #available(macOS 12.0,tvOS 15.0,visionOS 1.0,iOS 17.0,watchOS 8.0, *) {
...
@Event private var _0_onDismiss__0: Event.EventHandler
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,tvOS 14.0,iOS 14.0,watchOS 7.0, *)
...
self.__0_onDismiss__0 = onDismiss__0
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(content):
            if #available(visionOS 1.0,tvOS 14.0,iOS 14.0,watchOS 7.0, *) {
            let content = content as! ViewReference
...
struct _gestureModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 2.0,watchOS 11.0,tvOS 18.0,macOS 15.0,iOS 18.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._2(gesture, name, isEnabled):
            if #available(visionOS 2.0,watchOS 11.0,tvOS 18.0,macOS 15.0,iOS 18.0, *) {
...
struct _handGestureShortcutModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(watchOS)
    @available(macOS 15.0,watchOS 11.0,tvOS 18.0,iOS 18.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(shortcut, isEnabled):
            if #available(macOS 15.0,watchOS 11.0,tvOS 18.0,iOS 18.0, *) {
...
struct _labelsVisibilityModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 15.0,tvOS 18.0,visionOS 2.0,iOS 18.0,watchOS 11.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(visibility):
            if #available(macOS 15.0,tvOS 18.0,visionOS 2.0,iOS 18.0,watchOS 11.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _listSectionSpacingModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(visionOS) || os(watchOS)
    @available(watchOS 10.0,iOS 17.0,visionOS 1.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(visionOS) || os(watchOS)
        case let ._0(spacing):
            if #available(watchOS 10.0,iOS 17.0,visionOS 1.0, *) {
...
struct _menuStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(macOS 11.0,visionOS 1.0,tvOS 17.0,iOS 14.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
        case let ._0(style):
            if #available(macOS 11.0,visionOS 1.0,tvOS 17.0,iOS 14.0, *) {
...
struct _navigationBarHiddenModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,macOS 13.0,tvOS 13.0,iOS 13.0,watchOS 6.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(hidden):
            if #available(visionOS 1.0,macOS 13.0,tvOS 13.0,iOS 13.0,watchOS 6.0, *) {
...
@Event private var _3_action__0: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(iOS 13.0,macOS 10.15,visionOS 1.0,watchOS 6.0,tvOS 14.0, *)
...
self.__3_action__0 = action__0
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(minimumDuration, maximumDistance):
            if #available(iOS 13.0,macOS 10.15,visionOS 1.0,watchOS 6.0,tvOS 14.0, *) {
...
struct _scrollContentBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,watchOS 9.0,iOS 16.0,macOS 13.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
        self.value = ._0(visibility: visibility)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility):
            if #available(visionOS 1.0,watchOS 9.0,iOS 16.0,macOS 13.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _searchPresentationToolbarBehaviorModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 14.1,tvOS 17.1,visionOS 1.0,iOS 17.1,watchOS 10.1, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(behavior):
            if #available(macOS 14.1,tvOS 17.1,visionOS 1.0,iOS 17.1,watchOS 10.1, *) {
...
struct _swipeActionsModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,macOS 12.0,iOS 15.0,watchOS 8.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(edge, allowsFullSwipe, content):
            if #available(visionOS 1.0,macOS 12.0,iOS 15.0,watchOS 8.0, *) {
...
struct _textInputAutocapitalizationModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 15.0,visionOS 1.0,watchOS 8.0,iOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(autocapitalization):
            if #available(tvOS 15.0,visionOS 1.0,watchOS 8.0,iOS 15.0, *) {
...
struct _toolbarModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(iOS 17.0,macOS 14.0,visionOS 1.0,watchOS 10.0,tvOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._1(defaultItemKind):
            if #available(iOS 17.0,macOS 14.0,visionOS 1.0,watchOS 10.0,tvOS 17.0, *) {
...
struct _toolbarVisibilityModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(watchOS 11.0,visionOS 2.0,tvOS 18.0,iOS 18.0,macOS 15.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>,for bars: SwiftUI.ToolbarPlacement) {
        self.value = ._0(visibility: visibility, bars: bars)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility, bars):
            if #available(watchOS 11.0,visionOS 2.0,tvOS 18.0,iOS 18.0,macOS 15.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
let bars = bars as! SwiftUI.ToolbarPlacement
...
/// * `.disabled`
@_documentation(visibility: public)
@available(tvOS 17.0,watchOS 10.0,visionOS 1.0,iOS 17.0,macOS 14.0, *)
...
if #available(tvOS 15.0,watchOS 8.0,visionOS 1.0,macOS 12.0,iOS 15.0, *) {
...
if #available(tvOS 17.0,watchOS 8.0,visionOS 1.0,macOS 12.0,iOS 15.0, *) {
...
if #available(tvOS 18.0,watchOS 8.0,visionOS 1.0,macOS 12.0,iOS 15.0, *) {
...
if #available(tvOS 16.0,visionOS 1.0,iOS 16.0,macOS 13.0,watchOS 9.0, *) {
...
/// * `.scrolls`
@_documentation(visibility: public)
@available(tvOS 16.4,watchOS 9.4,visionOS 1.0,iOS 16.4,macOS 13.3, *)
...
/// * `.basedOnSize`
@_documentation(visibility: public)
@available(tvOS 16.4,iOS 16.4,watchOS 9.4,macOS 13.3,visionOS 1.0, *)
...
@_documentation(visibility: public)
@available(tvOS 16.4,visionOS 1.0,iOS 16.4,macOS 13.3,watchOS 9.4, *)
...
if #available(tvOS 16.0,watchOS 9.0,visionOS 1.0,iOS 16.0,macOS 13.0, *) {
