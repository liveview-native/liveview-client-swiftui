...
struct _automationElementModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 18.1,iOS 18.1,visionOS 2.1,watchOS 11.1,macOS 15.1, *)
    init() {
        self.value = ._0
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case ._0:
            if #available(tvOS 18.1,iOS 18.1,visionOS 2.1,watchOS 11.1,macOS 15.1, *) {
...
struct _controlGroupStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
    @available(macOS 12.0,visionOS 1.0,iOS 15.0,tvOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS)
        case let ._0(style):
            if #available(macOS 12.0,visionOS 1.0,iOS 15.0,tvOS 17.0, *) {
...
struct _controlSizeModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(iOS 15.0,visionOS 1.0,watchOS 9.0,macOS 10.15, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(controlSize):
            if #available(iOS 15.0,visionOS 1.0,watchOS 9.0,macOS 10.15, *) {
...
struct _datePickerStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(watchOS 10.0,macOS 10.15,iOS 13.0,visionOS 1.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(watchOS 10.0,macOS 10.15,iOS 13.0,visionOS 1.0, *) {
...
struct _defaultScrollAnchorModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 14.0,visionOS 1.0,watchOS 10.0,iOS 17.0,tvOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(anchor):
            if #available(macOS 14.0,visionOS 1.0,watchOS 10.0,iOS 17.0,tvOS 17.0, *) {
...
@ChangeTracked private var _3_isSuppressed: Swift.Bool
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 14.0,visionOS 1.0,tvOS 17.0,watchOS 10.0,iOS 17.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(titleKey):
            if #available(macOS 14.0,visionOS 1.0,tvOS 17.0,watchOS 10.0,iOS 17.0, *) {
...
@Event private var _2_onFocusChange__1: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 15.0,watchOS 8.0,macOS 12.0,iOS 17.0,visionOS 1.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(isFocusable):
            if #available(tvOS 15.0,watchOS 8.0,macOS 12.0,iOS 17.0,visionOS 1.0, *) {
...
@Event private var _0_onDismiss__0: Event.EventHandler
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,tvOS 14.0,watchOS 7.0,iOS 14.0, *)
...
self.__0_onDismiss__0 = onDismiss__0
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(content):
            if #available(visionOS 1.0,tvOS 14.0,watchOS 7.0,iOS 14.0, *) {
            let content = content as! ViewReference
...
struct _handGestureShortcutModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(watchOS)
    @available(tvOS 18.0,iOS 18.0,watchOS 11.0,macOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(shortcut, isEnabled):
            if #available(tvOS 18.0,iOS 18.0,watchOS 11.0,macOS 15.0, *) {
...
struct _indexViewStyleModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,tvOS 14.0,watchOS 8.0,iOS 14.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(visionOS 1.0,tvOS 14.0,watchOS 8.0,iOS 14.0, *) {
...
struct _labelsVisibilityModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(tvOS 18.0,watchOS 11.0,macOS 15.0,iOS 18.0,visionOS 2.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(visibility):
            if #available(tvOS 18.0,watchOS 11.0,macOS 15.0,iOS 18.0,visionOS 2.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _navigationBarHiddenModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,tvOS 13.0,watchOS 6.0,macOS 13.0,iOS 13.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(hidden):
            if #available(visionOS 1.0,tvOS 13.0,watchOS 6.0,macOS 13.0,iOS 13.0, *) {
...
struct _navigationBarTitleModifier<R: RootRegistry>: ViewModifier {
    ...
    #endif
    #if os(iOS) || os(visionOS)
    @available(watchOS 6.0,macOS 13.0,visionOS 1.0,iOS 13.0,tvOS 13.0, *)
...
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
        ...
        case let ._5(title, displayMode):
            if #available(watchOS 6.0,macOS 13.0,visionOS 1.0,iOS 13.0,tvOS 13.0, *) {
            let title = title as! AttributeReference<String>
let displayMode = displayMode as! SwiftUI.NavigationBarItem.TitleDisplayMode
...
@ChangeTracked private var _4_title: Swift.String
    ...
    #if os(watchOS)
    @available(macOS 11.0,watchOS 7.0,iOS 14.0,tvOS 14.0, *)
...
@Event private var _3_action__0: Event.EventHandler
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(tvOS 14.0,macOS 10.15,visionOS 1.0,iOS 13.0,watchOS 6.0, *)
...
self.__0_onPressingChanged__1 = onPressingChanged__1
    ...
    #endif
    #if os(tvOS)
    @available(tvOS 14.0,macOS 10.15,iOS 13.0,watchOS 6.0, *)
...
self.__3_action__0 = action__0
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(minimumDuration, maximumDistance):
            if #available(tvOS 14.0,macOS 10.15,visionOS 1.0,iOS 13.0,watchOS 6.0, *) {
...
let maximumDistance = maximumDistance as! AttributeReference<CoreFoundation.CGFloat>
        ...
        case let ._1(minimumDuration):
            if #available(tvOS 14.0,macOS 10.15,iOS 13.0,watchOS 6.0, *) {
            let minimumDuration = minimumDuration as! AttributeReference<Swift.Double>
...
@Event private var _0_action__2: Event.EventHandler
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case ._0:
            if #available(visionOS 2.0,tvOS 18.0,iOS 18.0,watchOS 11.0,macOS 15.0, *) {
...
struct _presentationBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 13.3,visionOS 1.0,iOS 16.4,tvOS 16.4,watchOS 9.4, *)
    init(_ style: AnyShapeStyle.Resolvable) {
        self.value = ._0(style: style)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(style):
            if #available(macOS 13.3,visionOS 1.0,iOS 16.4,tvOS 16.4,watchOS 9.4, *) {
...
struct _presentationBackgroundInteractionModifier<R: RootRegistry>: ViewModifier {
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(interaction):
            if #available(tvOS 16.4,watchOS 9.4,macOS 13.3,iOS 16.4,visionOS 1.0, *) {
...
struct _scrollContentBackgroundModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(macOS 13.0,watchOS 9.0,iOS 16.0,visionOS 1.0, *)
    init(_ visibility: AttributeReference<SwiftUI.Visibility>) {
        self.value = ._0(visibility: visibility)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
        case let ._0(visibility):
            if #available(macOS 13.0,watchOS 9.0,iOS 16.0,visionOS 1.0, *) {
            let visibility = visibility as! AttributeReference<SwiftUI.Visibility>
...
struct _searchPresentationToolbarBehaviorModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(macOS 14.1,visionOS 1.0,iOS 17.1,tvOS 17.1,watchOS 10.1, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        #if os(iOS) || os(macOS) || os(tvOS) || os(visionOS) || os(watchOS)
        case let ._0(behavior):
            if #available(macOS 14.1,visionOS 1.0,iOS 17.1,tvOS 17.1,watchOS 10.1, *) {
...
struct _swipeActionsModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(macOS) || os(visionOS) || os(watchOS)
    @available(watchOS 8.0,macOS 12.0,visionOS 1.0,iOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(edge, allowsFullSwipe, content):
            if #available(watchOS 8.0,macOS 12.0,visionOS 1.0,iOS 15.0, *) {
...
struct _textInputAutocapitalizationModifier<R: RootRegistry>: ViewModifier {
    ...
    #if os(iOS) || os(tvOS) || os(visionOS) || os(watchOS)
    @available(visionOS 1.0,tvOS 15.0,watchOS 8.0,iOS 15.0, *)
    ...
    func body(content __content: Content) -> some View {
        ...
        case let ._0(autocapitalization):
            if #available(visionOS 1.0,tvOS 15.0,watchOS 8.0,iOS 15.0, *) {
...
if #available(macOS 14.0,iOS 18.0,watchOS 10.0,tvOS 17.0, *) {
...
if #available(macOS 14.0,iOS 18.0,watchOS 11.0,tvOS 17.0, *) {
...
if #available(macOS 12.0,tvOS 15.0,watchOS 8.0,iOS 15.0,visionOS 1.0, *) {
...
if #available(macOS 12.0,tvOS 17.0,watchOS 8.0,iOS 15.0,visionOS 1.0, *) {
...
if #available(macOS 12.0,tvOS 18.0,watchOS 8.0,iOS 15.0,visionOS 1.0, *) {
...
if #available(macOS 14.0,tvOS 17.0,watchOS 10.0,visionOS 1.0,iOS 17.0, *) {
...
/// * `.standard`
@_documentation(visibility: public)
@available(macOS 13.0,iOS 17.0,watchOS 10.0,tvOS 17.0,visionOS 1.0, *)
...
if #available(iOS 16.0,macOS 13.0,visionOS 1.0,watchOS 9.0,tvOS 16.0, *) {
...
@_documentation(visibility: public)
@available(iOS 16.4,macOS 13.3,visionOS 1.0,watchOS 9.4,tvOS 16.4, *)
...
if #available(macOS 15.0,iOS 18.0,watchOS 10.0,tvOS 17.0,visionOS 2.0, *) {
    return Self.title
...
if #available(macOS 13.0,visionOS 1.0,iOS 16.0,tvOS 16.0,watchOS 9.0, *) {
