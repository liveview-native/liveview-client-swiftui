...
enum StylesheetResolvableLabeledContentStyle: LabeledContentStyle, StylesheetResolvable {
    case automatic
}
...
extension StylesheetResolvableLabeledContentStyle: AttributeDecodable {
