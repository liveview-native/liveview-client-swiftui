...
extension MatchedGeometryEffectModifier: RuntimeViewModifier {
    ...
    public func body(content _content: Content) -> some View {
        switch self {
        case .matchedGeometryEffect(id: let id, in: let `in`, properties: let properties, anchor: let anchor, isSource: let isSource):
            _content.matchedGeometryEffect(id: id, in: `in`, properties: properties, anchor: anchor, isSource: isSource)
        }
    }
}