...
// MARK: - FocusedSceneValueModifier (NOT SUPPORTED)
//
// The `focusedSceneValue(_:_:)` modifier CANNOT be supported in LightpandaRenderer because it requires
...
//
// This modifier works the same as `focusedValue` but shares the value across scenes.
//
